...
String DeviceID = String("S18"); //change according to the device
const char* topic="S18/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S18.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S18.bin"
...
const char* WIFI_SSID = "KDONGLE18";
const char* WIFI_PASSWD = "K@@tru!818";
