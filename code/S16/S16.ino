...
String DeviceID = String("S16"); //change according to the device
const char* topic="S16/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S16.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S16.bin"
...
const char* WIFI_SSID = "KDONGLE16";
const char* WIFI_PASSWD = "K@@tru!816";
