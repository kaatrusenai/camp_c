...
String DeviceID = String("S11"); //change according to the device
const char* topic="S11/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S11.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S11.bin"
...
const char* WIFI_SSID = "KDONGLE11";
const char* WIFI_PASSWD = "K@@tru!811";
