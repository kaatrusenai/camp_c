...
String DeviceID = String("S13"); //change according to the device
const char* topic="S13/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S13.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S13.bin"
...
const char* WIFI_SSID = "KDONGLE13";
const char* WIFI_PASSWD = "K@@tru!813";
