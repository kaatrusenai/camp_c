...
const char* topicsen="M7/sen"; //change according to the device
const char* topicacc="M7/acc";
const char* topic1="dev/reg";
#define LENG 31 //0x42 + 31 bytes equal to 32 bytes
unsigned char buf[LENG];
char col;
int PM01Value = 0; //define PM1.0 value of the air detector module
int PM2_5Value = 0; //define PM7.5 value of the air detector module
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/M7.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/M7.bin"
