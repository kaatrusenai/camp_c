...
String DeviceID = String("S14"); //change according to the device
const char* topic="S14/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S14.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S14.bin"
...
const char* WIFI_SSID = "KDONGLE14";
const char* WIFI_PASSWD = "K@@tru!814";
