...
const char* topicsen="M1/sen"; //change according to the device
const char* topicacc="M1/acc";
...
const char* WIFI_SSID = "KDONGLE19";
const char* WIFI_PASSWD = "K@@tru!819";
