...
const char* topic="S2/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S2.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S2.bin"
...
const char* WIFI_SSID = "KDONGLE2";
const char* WIFI_PASSWD = "K@@tru!82";
