...
const char* topic="S4/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S4.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S4.bin"
...
const char* WIFI_SSID = "KDONGLE4";
const char* WIFI_PASSWD = "K@@tru!84";
