...
const char* topicsen="M4/sen"; //change according to the device
const char* topicacc="M4/acc";
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/M4.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/M4.bin"

void firmwareUpdate();
int FirmwareVersionCheck();

const char* WIFI_SSID = "KDONGLE22";
const char* WIFI_PASSWD = "K@@tru!822";
