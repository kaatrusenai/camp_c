...
String DeviceID = String("S17"); //change according to the device
const char* topic="S17/sen"; //change according to the device
...
#define URL_fw_Version "https://raw.githubusercontent.com/kaatrusenai/camp_a/main/S17.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/kaatrusenai/camp_b/main/S17.bin"
...
const char* WIFI_SSID = "KDONGLE17";
const char* WIFI_PASSWD = "K@@tru!817";
